        ...
        <section style={{color: mode==='dark'?'white':'black'}}>
            ...
            {!userInfo 
                ?
                    <Loader />
                :
                    <div className="container"  style={{backgroundColor: mode==='dark'?'rgb(36 74 104)':'white',color: mode==='dark'?'white':'black'}}>
                        <table className="table">
                            ...
                            <tbody>
                                <tr>
                                    <th style={{color: mode==='dark'?'white':'black'}} scope="row">{userInfo._id}</th>
                                    ...
                                    <td style={{color: mode==='dark'?'white':'black'}}>{userInfo.createdAt.split("T")[0]}</td>
                                    <td style={{color: mode==='dark'?'white':'black'}}>
                                        {isEditing ? 
                                                <button 
